                                ...
                                <form method="post" action="${pageContext.request.contextPath }/Manager_addOrUpdate.action">
                                    ...
                                    <!-- <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Address</label>
                                                <input type="text" class="form-control border-input" placeholder="Home Address" value="你家住在黄土高坡">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>About Me</label>
                                                    <textarea rows="5" class="form-control border-input" placeholder="Here can be your description" value="Mike">嘿！对面的朋友你们好嘛！
让我看到你们的双手！
                                                    </textarea>
                                            </div>
                                        </div>
