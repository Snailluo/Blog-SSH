                ...
                <div class="row">
                    <div class="col-lg-8 col-md-7">
                        <div class="card">
                            ...
                            <div class="content">
                                <form method="post" action="${pageContext.request.contextPath }/Catalog_addOrUpdate.action">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>栏目标题</label>
                                                <input name="caname" type="text" class="form-control border-input" 
                                                	placeholder="栏目标题" value="${catalog.caname }">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>栏目编号</label>
                                                <input name="canumber" type="text" class="form-control border-input" 
                                                	placeholder="栏目编号" value="${catalog.canumber }">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>用户状态</label>
                                                <select class="form-control" name="castate">
                                                <c:choose>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <input type="hidden" name="caid" value="${catalog.caid}" />
                                    </div>
